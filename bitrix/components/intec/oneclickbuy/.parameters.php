...
if(CModule::IncludeModule("iblock") && CModule::IncludeModule("sale") && CModule::IncludeModule("catalog") && CModule::IncludeModule("currency"))
{
	...
	$arOrderFields = array( "USER_NAME" => GetMessage('FIELD_OPTION_USER_NAME'), "PHONE" => GetMessage('FIELD_OPTION_PHONE'), "EMAIL" => GetMessage('FIELD_OPTION_EMAIL'), );
	...
	$arComponentParameters = array(
		...
		"PARAMETERS" => array(
			...
			"PROPERTIES" => Array(
				...
				"DEFAULT" => array('USER_NAME', 'PHONE', 'EMAIL'),
				"ADDITIONAL_VALUES" => "N",
				"REFRESH" => "N",
				"MULTIPLE" => "Y",
			),
