...
$iBlockPrices = CIBlockPriceTools::GetCatalogPrices($arParams['IBLOCK_ID'], $arParams['PRICE_CODE']);
...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		{
			$arItem['CATALOG'] = true;
            $arItem['OFFERS'] = CIBlockPriceTools::GetOffersArray(
                array('IBLOCK_ID' => $arParams['IBLOCK_ID'], 'HIDE_NOT_AVAILABLE' => 'N'),
                array($arItem['ID']),
                array(),
                array(),
                array(),
