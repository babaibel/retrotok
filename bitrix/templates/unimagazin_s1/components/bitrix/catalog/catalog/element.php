...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	array(
		...
		"PRODUCT_OF_DAY_SHOW_IF_END" => "N",
		'OCB_USE' => $arParams['OCB_USE'],
		'OCB_TYPE_DELIVERY' => $arParams['OCB_TYPE_DELIVERY'],
		'OCB_TYPE_PERSON' => $arParams['OCB_TYPE_PERSON'],
		'OCB_TYPE_PAYMENT' => $arParams['OCB_TYPE_PAYMENT']
	),
	$component
);
