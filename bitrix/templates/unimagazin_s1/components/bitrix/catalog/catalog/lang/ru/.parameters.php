...
$MESS["REVIEWS_IBLOCK_IBLOCK"] = "Инфоблок отзывов";
$MESS["GRID_CATALOG_ROOT_SECTIONS_COUNT"] = "Количество корневых категорий, выводимых в одной строке таблицы";
$MESS["GRID_CATALOG_SECTIONS_COUNT"] = "Количество категорий, выводимых в одной строке таблицы";
$MESS['CP_BC_VIEWED_CURRENCY'] = 'Валюта цены просмотренных товаров';

$MESS['OCB_USE'] = "Использовать \"Купить в 1 клик\"";
$MESS['OCB_TYPE_PERSON'] = "Тип плательщика при покупки в один клик";
$MESS['OCB_TYPE_DELIVERY'] = "Тип доставки при покупки в один клик";
$MESS['OCB_TYPE_PAYMENT'] = "Способ оплаты при покупки в один клик";
?>