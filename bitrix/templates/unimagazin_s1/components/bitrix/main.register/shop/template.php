...
if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)
	die();
?>
<div class="bx-auth-reg faq">
<div class="close_form jqmClose "></div>
...
<form method="post" class="capital faq" style="margin-bottom:0;" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
<?
if($arResult["BACKURL"] <> ''):
?>
...
<table style="width:100%; padding-top: 20px; clear:both;">	
	<tbody>
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	<?if($FIELD == "AUTO_TIME_ZONE" && $arResult["TIME_ZONE_ENABLED"] == true):?>
		...
		<tr>
			<td><?echo GetMessage("main_profile_time_zones_zones")?>
				<div class="clear"></div>
	...
	<?else:?>
		<tr>
			<td colspan="2"><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="starrequired">*</span><?endif?><div class="clear"></div>
			<?
	switch ($FIELD)
	{
		case "PASSWORD":
...
if ($arResult["USE_CAPTCHA"] == "Y")
{
	?>
		<tr>
			<td colspan="2"><b><?=GetMessage("REGISTER_CAPTCHA_TITLE")?></b>
				<div class="clear"></div>
		...
		<tr>
			<td colspan="2"><?=GetMessage("REGISTER_CAPTCHA_PROMT")?>:<span class="starrequired">*</span><div class="clear"></div>
	...
	<tfoot>
		<tr>
			<td colspan="2" style="text-align:center;">
				<input type="submit" name="register_submit_button" class="button" value="<?=GetMessage("AUTH_REGISTER")?>" />
			</td>
		</tr>
	</tfoot>
</table>
