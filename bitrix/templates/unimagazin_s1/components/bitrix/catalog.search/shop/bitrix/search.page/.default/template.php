...
<?else:?>
	<input type="text" name="q" class="uni-input-text" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
	&nbsp;<input type="submit" class="uni-button solid_button button" value="<?=GetMessage("SEARCH_GO")?>" />
