...
else
{
	...
	?>
	<?if (!$bPrevDisabled):?>
				<li class="text_pag"><a href="<?=$sPrevHref;?>" id="<?=$ClientID?>_previous_page"><?=GetMessage("NAV_BACK")?></a></li>
	<?endif?>
	<?
	$bFirst = true;
	$bPoints = false;
	...
	?>
	<?if (!$bNextDisabled):?>
				<li class="text_pag"><a href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page"><?=GetMessage("NAV_NEXT")?></a></li>
	<?endif;
}
?>
