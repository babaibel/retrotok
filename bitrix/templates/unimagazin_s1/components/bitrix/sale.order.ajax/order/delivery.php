...
<div class="bx_section left delivery-section" style="width: 50%; margin-bottom: 0px;">
	<?
	if(!empty($arResult["DELIVERY"]))
	{
		...
		foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery)
		{
			...
			?>
			<div class="bx_block delivery">

				<div class="bx_element delivery">
							...
							<div class="bx_description">
								...
								<span class="bx_result_price">
									<?if(isset($arDelivery["PRICE"])):?>
										<?=GetMessage("SALE_DELIV_PRICE");?>: <?=(strlen($arDelivery["PRICE_FORMATED"]) > 0 ? $arDelivery["PRICE_FORMATED"] : number_format($arDelivery["PRICE"], 2, ',', ' '))?><br />
										<?
