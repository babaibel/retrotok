...
$MESS["CP_BCE_TPL_PROP_CODE"] = "Таблица с брендами";
$MESS["PRODUCT_OF_DAY_SHOW"] = "Показывать что это товар дня";
$MESS["PRODUCT_OF_DAY_SHOW_IF_END"] = "Показывать что это товар дня, если акция завершена";
?>