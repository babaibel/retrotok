...
$MESS["CT_BSE_FORMAT_LABEL"] = "Предпочитаемый формат писем:";
$MESS["CT_BSE_FORMAT_TEXT"] = "Текст";
$MESS["CT_BSE_FORMAT_HTML"] = "HTML";
$MESS["CT_BSE_RUBRIC_LABEL"] = "Рубрики подписки";
...
$MESS["CT_BSE_CONF_NOTE"] = "Ваша подписка не подтверждена.";
$MESS["CT_BSE_CONF_NOTE1"] = "Введите код подтверждения подписки";
