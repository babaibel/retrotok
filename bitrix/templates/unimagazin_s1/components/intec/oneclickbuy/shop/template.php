			...
			<div id="ocb-params">
				...
				<?foreach ( $arParams['PROPERTIES'] as $field ) {
					...
					<div class="ocb-form-field">
						...
						<?if ($field=="COMMENT"):?>
							<textarea name="ONE_CLICK_BUY[<?=$field?>]" class="uni-input-textarea" id="ocb-id-<?=$field?>"></textarea>
							<? if (in_array($field, $arParams['REQUIRED'])):?><div class="requared"><?=GetMessage("IBLOCK_FORM_IMPORTANT")?></div><?endif;?>
						<?else:?>
							<input type="text" class="uni-input-text" name="ONE_CLICK_BUY[<?=$field?>]" value="<?=$value?>" id="ocb-id-<?=$field?>" />
							<? if (in_array($field, $arParams['REQUIRED'])):?><div class="requared"><?=GetMessage("IBLOCK_FORM_IMPORTANT")?></div><?endif;?>
						<?endif;?>
